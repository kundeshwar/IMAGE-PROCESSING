...
dict_1 = { 1:"Greay", 2:"Binary", 3:"blue", 4:"smoothing the image", 5:"blurring the image", 6:"Detection the edge of image", 7:"saturation", 8:"green", 9:"white", 10:"red", 11:"hue", 12:"cropping the image", 13:"doubling the image", 14:"Transposing the image", 15:"Face detection", 16:"Hiatogram of the image", 17:"Pyramid of the image", 18:"Transformation", 19:"Edge detection", 20:"Image Gradient", 21:"Hough Line Transform of image", 22:"Hough Circle Transform of image", 23:"Template Matching of image", 24:"Changing Colorspaces", 25:"Image Filtering"}
...
while(True):
    ...
    if num=='1':
        ...
        a = input('''There are two types of blurring available :- 1. Gaussian Blurring, 2. Median Blurring.
        ...
        if a==1:
            ...
            cv2.imshow("GaussianBlur",median)
            img1=median
    elif num=='6':
